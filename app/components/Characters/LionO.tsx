...
const LionO = () => (
    <div>
        ...
        <p>
            ...
            to adulthood, though he did not express any confusion regarding why
            WilyKat and WilyKit had not also aged as he had, which seems to indicate
            that he simply accepted it as a quirk of the capsules.
            Although cunning and skillful, he is truly a child in a man's body,
            and throughout the series, must learn what it takes to become a true
            leader and gain true maturity.
        </p>
    </div>
);

export default LionO;