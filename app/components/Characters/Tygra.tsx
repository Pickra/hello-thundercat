...
const Tygra = () => (
    <div>
        ...
        <p>
            A staunch, level-headed warrior based on the tiger,
            ...
            <a
                ...
                title="New Thundera"
            >New Thundera</a>.
            He is also gifted with "mind-power" — the ability to create
            ...
            >All That Glitters</a>,"
            Lion-O instructs Tygra, "If I do not return, you will be the new
            Lord of the ThunderCats."
            This verifies that indeed, Tygra is the second-in-command.
        </p>
    </div>
);

export default Tygra;